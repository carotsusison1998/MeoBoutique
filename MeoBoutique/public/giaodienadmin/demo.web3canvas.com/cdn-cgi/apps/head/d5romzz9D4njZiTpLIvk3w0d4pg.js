...
CloudflareApps.siteId = "d54782092980001a7ac0b68bd1e1d1ef";
...
CloudflareApps.installs["Gja7vEoCkvPD"] = {
    appId: "XzVIEqe1R2kW",
    scope: {}
};;
CloudflareApps.installs["Gja7vEoCkvPD"].options = {
    "chrome": 0,
    "edge": 17,
    "firefox": 0,
    "ie": 11,
...
CloudflareApps.installs["lzvdEj2bhKN1"] = {
    appId: "lMxPPXVOqmoE",
    scope: {}
};;
CloudflareApps.installs["lzvdEj2bhKN1"].options = {
    "id": "UA-38030533-1",
    "social": true
};;
CloudflareApps.installs["8SMY3u9XSU2v"] = {
    appId: "nt4L5NPJq1za",
    scope: {}
};;
CloudflareApps.installs["8SMY3u9XSU2v"].options = {
    "blocks": [{
        "code": "\u003cscript type=\"text/javascript\"\u003e!function(e,t,n){function a(){var e=t.getElementsByTagName(\"script\")[0],n=t.createElement(\"script\");n.type=\"text/javascript\",n.async=!0,n.src=\"https://beacon-v2.helpscout.net\",e.parentNode.insertBefore(n,e)}if(e.Beacon=n=function(t,n,a){e.Beacon.readyQueue.push({method:t,options:n,data:a})},n.readyQueue=[],\"complete\"===t.readyState)return a();e.attachEvent?e.attachEvent(\"onload\",a):e.addEventListener(\"load\",a,!1)}(window,document,window.Beacon||function(){});\u003c/script\u003e\u003cscript\u003ewindow.Beacon('init', 'e5f4e1ae-d219-4b46-9385-242e16c6d443')\u003c/script\u003e",
        "location": {
            "method": "append",
            "pages": {
                "URLPatterns": ["^demo.web3canvas.com/?.*$"]
            },
            "selector": "body"
        }
    }]
};;
CloudflareApps.installs["8SMY3u9XSU2v"].selectors = {
    "blocks[0].location.selector": "body"
};;
if (CloudflareApps.matchPage(CloudflareApps.installs['8SMY3u9XSU2v'].URLPatterns)) {
    (function() {
        'use strict'
        if (!document.addEventListener) return
        var options = CloudflareApps.installs['8SMY3u9XSU2v'].options
        var elements = {}
        var prevElements = {}
        ...
        window.CloudflareApps.installs['8SMY3u9XSU2v'].scope = {
...
if (CloudflareApps.matchPage(CloudflareApps.installs['lzvdEj2bhKN1'].URLPatterns)) {
    (function() {
        var options = CloudflareApps.installs['lzvdEj2bhKN1'].options;
        var id;
    ...
    script.src = '/cdn-cgi/apps/body/at8SSPnfnV6vhCRnQFlSHZWR_DA.js';
