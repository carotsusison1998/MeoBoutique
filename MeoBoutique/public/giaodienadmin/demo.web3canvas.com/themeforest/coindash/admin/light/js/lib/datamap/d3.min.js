d3 = function() {
    ...
    function d(n) {
        for (var t = new s, e = 0, r = arguments.length; ++e < r;) t[arguments[e]] = h(t);
    ...
    function N(n) {
        return arguments.length || (n = va.ascending),
            function(t, e) {
    ...
    function C(n, t, e) {
        ...
        function u() {
            var t, e = new RegExp("^__on([^.]+)" + va.requote(n) + "$");
            for (var r in this)
                if (t = r.match(e)) {
                    var i = this[r];
    ...
    function j(n) {
        ...
        return u[Ya] = "none",
            function(n) {
                ...
                i.on(t, null).on(e, null), u[Ya] = a, n && (i.on(r, function() {
                    g(), o()
                }, !0), setTimeout(o, 0))
            }
    }
    ...
    function L(n, t) {
        ...
        if (e.createSVGPoint) {
            ...
            return Ua ? (r.x = t.pageX, r.y = t.pageY) : (r.x = t.clientX, r.y = t.clientY), r = r.matrixTransform(n.getScreenCTM().inverse()), [r.x, r.y]
        }
    ...
    function $(n, t, e) {
        return isNaN(n) && (n = 0), isNaN(t) && (t = 0), W(e, Math.cos(n *= Ja) * t, Math.sin(n) * t)
    }
    ...
    function G(n, t, e) {
        var r = (n + 16) / 116,
            i = r + t / 500,
            u = r - e / 200;
        return i = Q(i) * no, r = Q(r) * to, u = Q(u) * eo, et(tt(3.2404542 * i - 1.5371385 * r - .4985314 * u), tt(-.969266 * i + 1.8760108 * r + .041556 * u), tt(.0556434 * i - .2040259 * r + 1.0572252 * u))
    }

    function K(n, t, e) {
        return n > 0 ? Z(Math.atan2(e, t) * Ga, Math.sqrt(t * t + e * e), n) : Z(0 / 0, 0 / 0, n)
    }
    ...
    function ut(n, t, e) {
        ...
        return (u = uo.get(n)) ? t(u.r, u.g, u.b) : (null != n && "#" === n.charAt(0) && (4 === n.length ? (a = n.charAt(1), a += a, o = n.charAt(2), o += o, c = n.charAt(3), c += c) : 7 === n.length && (a = n.substring(1, 3), o = n.substring(3, 5), c = n.substring(5, 7)), a = parseInt(a, 16), o = parseInt(o, 16), c = parseInt(c, 16)), t(a, o, c))
    }
    ...
    function ot(n, t, e) {
        ...
        var r = nt((.4124564 * n + .3575761 * t + .1804375 * e) / no),
            i = nt((.2126729 * n + .7151522 * t + .072175 * e) / to),
            u = nt((.0193339 * n + .119192 * t + .9503041 * e) / eo);
    ...
    function ht(n) {
        return function(t, e, r) {
            return 2 === arguments.length && "function" == typeof e && (r = e, e = null), gt(t, e, n, r)
        }
    }
    ...
    function dt() {
        var n = mt(),
            t = vt() - n;
        t > 24 ? (isFinite(t) && (clearTimeout(lo), lo = setTimeout(dt, t)), co = 0) : (co = 1, fo(dt))
    }

    function mt() {
        for (var n = Date.now(), t = ao; t;) n >= t.time && (t.flush = t.callback(n - t.time)), t = t.next;
        return n
    }

    function vt() {
        for (var n, t = ao, e = 1 / 0; t;) t.flush ? t = n ? n.next = t.next : ao = t.next : (t.time < e && (e = t.time), t = (n = t).next);
        return oo = n, e
    }
    ...
    function kt() {
        ...
        Eo.point = function(a, o) {
            Eo.point = n, r = (t = a) * Ja, i = Math.cos(o = (e = o) * Ja / 2 + Ba / 4), u = Math.sin(o)
        }, Eo.lineEnd = function() {
            n(t, e)
        }
    }
    ...
    function Ft() {
        function n(n, i) {
            ...
            Ao += l, Co += l * (t + (t = a)), zo += l * (e + (e = o)), Do += l * (r + (r = c)), Ht(t, e, r)
        }
        var t, e, r;
        Fo.point = function(i, u) {
            i *= Ja;
            var a = Math.cos(u *= Ja);
            t = a * Math.cos(i), e = a * Math.sin(i), r = Math.sin(u), Fo.point = n, Ht(t, e, r)
        }
    }
    ...
    function Ot() {
        function n(n, t) {
            ...
            var e = Math.cos(t *= Ja),
                ...
                p = h && -Y(g) / h,
                d = Math.atan2(h, g);
            jo += p * l, Lo += p * f, Ho += p * s, Ao += d, Co += d * (r + (r = a)), zo += d * (i + (i = o)), Do += d * (u + (u = c)), Ht(r, i, u)
        }
        var t, e, r, i, u;
    ...
    function Zt(n, t) {
        return ((n = n.point)[0] < 0 ? n[1] - Ba / 2 - $a : Ba / 2 - n[1]) - ((t = t.point)[0] < 0 ? t[1] - Ba / 2 - $a : Ba / 2 - t[1])
    }
    ...
    function Bt(n, t) {
        ...
        for (var l = 0, f = t.length; f > l; ++l) {
            var s = t[l],
                h = s.length;
            if (h) {
                for (var g = s[0], p = g[0], d = g[1] / 2 + Ba / 4, m = Math.sin(d), v = Math.cos(d), y = 1;;) {
                    y === h && (y = 0), n = s[y];
                    var M = n[0],
                        x = n[1] / 2 + Ba / 4,
                        b = Math.sin(x),
                        ...
                        S = Math.abs(w) > Ba,
                        E = m * b;
                    if (So.add(Math.atan2(E * Math.sin(w), v * _ + E * Math.cos(w))), Math.abs(x) < $a && (o = !0), u += S ? w + (w >= 0 ? 2 : -2) * Ba : w, S ^ p >= e ^ M >= e) {
                        var k = qt(At(g), At(n));
                        zt(k);
                        var A = qt(i, k);
                        zt(A);
    ...
    function $t(n) {
        ...
        return {
            ...
            point: function(u, a) {
                var o = u > 0 ? Ba : -Ba,
                    c = Math.abs(u - e);
                Math.abs(c - Ba) < $a ? (n.point(e, r = (r + a) / 2 > 0 ? Ba / 2 : -Ba / 2), n.point(i, r), n.lineEnd(), n.lineStart(), n.point(o, r), n.point(u, r), t = 0) : i !== o && c >= Ba && (Math.abs(e - i) < $a && (e -= i * $a), Math.abs(u - o) < $a && (u -= o * $a), r = Wt(e, r, u, a), n.point(i, r), n.lineEnd(), n.lineStart(), n.point(o, r), t = 0), n.point(e = u, r = a), i = o
            },
            lineEnd: function() {
                n.lineEnd(), e = r = 0 / 0
            },
    ...
    function Wt(n, t, e, r) {
        ...
        return Math.abs(a) > $a ? Math.atan((Math.sin(t) * (u = Math.cos(r)) * Math.sin(e) - Math.sin(r) * (i = Math.cos(t)) * Math.sin(n)) / (i * u * a)) : (t + r) / 2
    }

    function Jt(n, t, e, r) {
        var i;
        if (null == n) i = e * Ba / 2, r.point(-Ba, i), r.point(0, i), r.point(Ba, i), r.point(Ba, 0), r.point(Ba, -i), r.point(0, -i), r.point(-Ba, -i), r.point(-Ba, 0), r.point(-Ba, i);
        ...
        function e(n) {
            ...
            return {
                ...
                point: function(s, h) {
                    ...
                    if (!e && (c = a = d) && n.lineStart(), d !== a && (g = r(e, p), (jt(e, g) || jt(p, g)) && (p[0] += $a, p[1] += $a, d = t(p[0], p[1]))), d !== a) f = 0, d ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) : (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g;
                    else if (l && e && o ^ d) {
                        var v;
        ...
        function r(n, t, e) {
            ...
            if (!(0 > M)) {
                ...
                var A = S - w,
                    N = Math.abs(A - Ba) < $a,
                    q = N || $a > A;
                if (!N && E > k && (_ = E, E = k, k = _), q ? N ? E + k > 0 ^ b[1] < (Math.abs(b[0] - w) < $a ? E : k) : E <= b[1] && b[1] <= k : A > Ba ^ (w <= b[0] && b[0] <= S)) {
                    var T = Ct(m, (-v + x) / y);
    ...
    function Qt(n, t, e, r) {
        function i(r, i) {
            return Math.abs(r[0] - n) < $a ? i > 0 ? 0 : 3 : Math.abs(r[0] - e) < $a ? i > 0 ? 2 : 1 : Math.abs(r[1] - t) < $a ? i > 0 ? 1 : 0 : i > 0 ? 3 : 2
        }
        ...
        function o(i, u) {
            var a = u[0] - i[0],
                o = u[1] - i[1],
                c = [0, 1];
            return Math.abs(a) < $a && Math.abs(o) < $a ? n <= i[0] && i[0] <= e && t <= i[1] && i[1] <= r : ne(n - i[0], a, c) && ne(i[0] - e, -a, c) && ne(t - i[1], o, c) && ne(i[1] - r, -o, c) ? (c[1] < 1 && (u[0] = i[0] + c[1] * a, u[1] = i[1] + c[1] * o), c[0] > 0 && (i[0] += c[0] * a, i[1] += c[0] * o), !0) : !1
        }
        return function(c) {
            function l(u) {
                var a = i(u, -1),
            ...
            function v(n, t) {
                n = Math.max(-Ro, Math.min(Ro, n)), t = Math.max(-Ro, Math.min(Ro, t));
                var e = g(n, t);
    ...
    function ue(n, t) {
        Io > n && (Io = n), n > Xo && (Xo = n), Vo > t && (Vo = t), t > Zo && (Zo = t)
    }
    ...
    function le() {
        function n(n, r) {
            var i = n - t,
                u = r - e,
                a = Math.sqrt(i * i + u * u);
            Co += a * (t + n) / 2, zo += a * (e + r) / 2, Do += a, ce(t = n, e = r)
        }
        var t, e;
    ...
    function se() {
        function n(n, t) {
            var e = n - r,
                u = t - i,
                a = Math.sqrt(e * e + u * u);
            Co += a * (r + n) / 2, zo += a * (i + t) / 2, Do += a, a = i * n - r * t, jo += a * (r + n), Lo += a * (i + t), Ho += 3 * a, ce(r = n, i = t)
        }
        var t, e, r, i;
    ...
    function ge(n) {
        function t(t) {
            ...
            function l(n, t) {
                a(s = n, h = t), g = M, p = x, d = b, m = _, v = w, S.point = a
            }

            function f() {
                e(M, x, y, b, _, w, g, p, s, d, m, v, u, t), S.lineEnd = o, o()
            }
            var s, h, g, p, d, m, v, y, M, x, b, _, w, S = {
                point: r,
                lineStart: i,
                lineEnd: o,
                polygonStart: function() {
        ...
        function e(t, u, a, o, c, l, f, s, h, g, p, d, m, v) {
            ...
            if (x > 4 * r && m--) {
                var b = o + g,
                    ...
                    C = q - u,
                    z = M * T - y * C;
                (z * z / x > r || Math.abs((y * T + M * C) / x - .5) > .3 || i > o * g + c * p + l * d) && (e(t, u, a, o, c, l, N, q, k, b /= S, _ /= S, w, m, v), v.point(N, q), e(N, q, k, b, _, w, f, s, h, g, p, d, m, v))
            }
        }
        var r = .5,
            i = Math.cos(30 * Ja),
    ...
    function me(n) {
        ...
        function e(n) {
            return n = o.invert((n[0] - c) / h, (l - n[1]) / h), n && [n[0] * Ga, n[1] * Ga]
        }
        ...
        return t.stream = function(n) {
                ...
                return arguments.length ? (x = null == n ? (_ = n, Po) : Kt((_ = +n) * Ja), i()) : _
                ...
                return arguments.length ? (d = n[0] % 360 * Ja, m = n[1] % 360 * Ja, r()) : [d * Ga, m * Ga]
            }, t.rotate = function(n) {
                return arguments.length ? (v = n[0] % 360 * Ja, y = n[1] % 360 * Ja, M = n.length > 2 ? n[2] % 360 * Ja : 0, r()) : [v * Ga, y * Ga, M * Ga]
    ...
    function ve(n, t) {
        return {
            point: function(e, r) {
                r = n(e * Ja, r * Ja), e = r[0], t.point(e > Ba ? e - 2 * Ba : -Ba > e ? e + 2 * Ba : e, r[1])
            },
            sphere: function() {
                t.sphere()
            },
    ...
    function we(n, t) {
        ...
        return function(i, u, a, o) {
            null != i ? (i = Se(e, i), u = Se(e, u), (a > 0 ? u > i : i > u) && (i += 2 * a * Ba)) : (i = n + 2 * a * Ba, u = n);
        ...
        var i = Math.cos(t),
            ...
            p = h ? function(n) {
                var t = Math.sin(n *= h) * g,
                    ...
                    i = e * l + t * s,
                    a = e * u + t * o;
                return [Math.atan2(i, r) * Ga, Math.atan2(a, Math.sqrt(r * r + i * i)) * Ga]
            } : function() {
                return [n * Ga, t * Ga]
            };
    ...
    function Te() {
        function n(n, i) {
            var u = Math.sin(i *= Ja),
                ...
                o = Math.abs((n *= Ja) - t),
                c = Math.cos(o);
            Jo += Math.atan2(Math.sqrt((o = a * Math.sin(o)) * o + (o = r * u - e * a * c) * o), e * u + r * a * c), t = n, e = u, r = a
        }
        var t, e, r;
        Go.point = function(i, u) {
            t = i * Ja, e = Math.sin(u *= Ja), r = Math.cos(u), Go.point = n
        }, Go.lineEnd = function() {
    ...
    function ze(n, t) {
        ...
        return u ? (e.invert = function(n, t) {
            ...
            return [Math.atan2(n, e) / u, 2 * Math.atan(Math.pow(a / r, 1 / u)) - Ba / 2]
        }, e) : je
    }
    ...
    function De(n, t) {
        ...
        var r = Math.cos(n),
            ...
            u = r / i + n;
        return Math.abs(i) < $a ? ye : (e.invert = function(n, t) {
            var e = u - t;
    ...
    function Fe(n) {
        ...
        return t.x = function(n) {
            ...
            return arguments.length ? (a = "function" == typeof n ? u = n : (u = rc.get(n) || Re).key, t) : a
    ...
    function $e(n, t) {
        ...
        if (e) {
            var f = n[c];
            r += "Q" + (u[0] + 2 * o[0] / 3) + "," + (u[1] + 2 * o[1] / 3) + "," + f[0] + "," + f[1]
        }
        return r
    }
    ...
    function Ge(n) {
        ...
        for (e.push(nr(ac, u) + "," + nr(ac, a)), --r; ++r < i;) t = n[r], u.shift(), u.push(t[0]), a.shift(), a.push(t[1]), tr(e, u, a);
        return e.join("")
    }

    function Ke(n) {
        for (var t, e, r = -1, i = n.length, u = i + 4, a = [], o = []; ++r < 4;) e = n[r % i], a.push(e[0]), o.push(e[1]);
        for (t = [nr(ac, a), ",", nr(ac, o)], --r; ++r < u;) e = n[r % i], a.shift(), a.push(e[0]), o.shift(), o.push(e[1]), tr(t, a, o);
        return t.join("")
    }
    ...
    function tr(n, t, e) {
        n.push("C", nr(ic, t), ",", nr(ic, e), ",", nr(uc, t), ",", nr(uc, e), ",", nr(ac, t), ",", nr(ac, e))
    }
    ...
    function lr(n, t) {
        var e = {
            ...
            i = {
                ...
                intersect: function(n, t) {
                    ...
                    return s && "l" === u.side || !s && "r" === u.side ? null : {
                        x: o,
                        y: c
                    }
                },
        ...
        for (var a, o, c, l, f, s, h, g, p, d, m, v, y, M = e.list.shift();;)
            if (u.empty() || (a = u.min()), M && (u.empty() || M.y < a.y || M.y == a.y && M.x < a.x)) o = r.leftBound(M), c = r.right(o), h = r.rightRegion(o), v = i.bisect(h, M), s = r.createHalfEdge(v, "l"), r.insert(o, s), d = i.intersect(o, s), d && (u.del(o), u.insert(o, d, i.distance(d, M))), o = s, s = r.createHalfEdge(v, "r"), r.insert(o, s), d = i.intersect(s, c), d && u.insert(s, d, i.distance(d, M)), M = e.list.shift();
                ...
                if (u.empty()) break;
                o = u.extractMin(), l = r.left(o), c = r.right(o), f = r.right(c), h = r.leftRegion(o), g = r.rightRegion(c), m = o.vertex, i.endPoint(o.edge, o.side, m), i.endPoint(c.edge, c.side, m), r.del(o), u.del(c), r.del(c), y = "l", h.y > g.y && (p = h, h = g, g = p, y = "r"), v = i.bisect(h, g), s = r.createHalfEdge(v, y), r.insert(l, s), i.endPoint(v, oc[y], m), d = i.intersect(l, s), d && (u.del(l), u.insert(l, d, i.distance(d, h))), d = i.intersect(s, f), d && u.insert(s, d, i.distance(d, h))
            }
    ...
    function dr(n) {
        var t = [n.a, n.b],
            ...
            i = mr(t, e),
            u = vr(yr(e, t, -i)) || 0;
        t[0] * e[1] < e[0] * t[1] && (t[0] *= -1, t[1] *= -1, r *= -1, i *= -1), this.rotate = (r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * Ga, this.translate = [n.e, n.f], this.scale = [r, u], this.skew = u ? Math.atan2(i, u) * Ga : 0
    }
    ...
    function _r(n, t) {
        var e, r, i, u, a, o = 0,
            ...
            l = [],
            f = [];
        for (n += "", t += "", lc.lastIndex = 0, r = 0; e = lc.exec(t); ++r) e.index && l.push(t.substring(o, c = e.index)), f.push({
            i: l.length,
            x: e[0]
        }), l.push(null), o = lc.lastIndex;
        ...
        for (; u > r;) a = f.pop(), null == l[a.i + 1] ? l[a.i] = a.x : (l[a.i] = a.x + l[a.i + 1], l.splice(a.i + 1, 1)), u--;
        return 1 === l.length ? null == l[0] ? (a = f[0].x, function(n) {
            return a(n) + ""
        }) : function() {
            return t
        } : function(n) {
    ...
    function Hr(n, t) {
        var e;
        return arguments.length < 2 && (t = .45), arguments.length ? e = t / (2 * Ba) * Math.asin(1 / n) : (n = 1, e = t / 4),
            function(r) {
    ...
    function Kr(n, t, e) {
        ...
        if (n.charge = 0, !n.leaf)
            for (var u, a = n.nodes, o = a.length, c = -1; ++c < o;) u = a[c], null != u && (Kr(u, t, e), n.charge += u.charge, r += u.charge * u.cx, i += u.charge * u.cy);
        if (n.point) {
    ...
    function Ti(n) {
        ...
        if ((e = n.children) && (l = e.length)) {
            var e, r, i, u, a, o, c, l, f = 1 / 0,
                ...
                h = 1 / 0,
                g = -1 / 0;
            if (e.forEach(Ci), r = e[0], r.x = -r.r, r.y = 0, t(r), l > 1 && (i = e[1], i.x = i.r, i.y = 0, t(i), l > 2))
                for (u = e[2], ji(r, i, u), t(u), Ai(r, u), r._pack_prev = u, Ai(u, i), i = r._pack_next, a = 3; l > a; a++) {
                    ji(r, i, u = e[a]);
                    var p = 0,
                        d = 1,
                        m = 1;
                    ...
                    if (1 == p)
                        for (c = r._pack_prev; c !== o._pack_prev && !qi(c, u); c = c._pack_prev, m++);
    ...
    function Qi(n, t, e) {
        ...
        return va.format(e ? e.replace(mo, function(n, t, e, i, u, a, o, c, l, f) {
    ...
    function nu(n, t, e, r, i) {
        ...
        return u.invert = function(t) {
            ...
            arguments.length < 2 ? i = Mc : "function" != typeof i && (i = va.format(i));
            var a, o = Math.log(t),
    ...
    function mu(n) {
        for (var t, e, r, i = -1, u = n.length; ++i < u;) t = n[i], e = t[0], r = t[1] + Sc, t[0] = e * Math.cos(r), t[1] = e * Math.sin(r);
        return n
    }
    ...
    function vu(n) {
        ...
        return t.x = function(n) {
            ...
            return arguments.length ? (c = "function" == typeof n ? o = n : (o = rc.get(n) || Re).key, l = o.reverse || o, f = o.closed ? "M" : "L", t) : c
        }, t.tension = function(n) {
    ...
    function Eu(n, t, e, r) {
        var i = n.id;
        return q(n, "function" == typeof e ? function(n, u, a) {
    ...
    function Tu(n, t, e) {
        if (r = [], e && t.length > 1) {
            for (var r, i, u, a = Yi(n.domain()), o = -1, c = t.length, l = (t[1] - t[0]) / ++e; ++o < c;)
    ...
    function ca(n, t, e) {
        ...
        return r.invert = function(t) {
            ...
            if ("function" != typeof e) {
                ...
                Math.log(o / cl[c - 1]) < Math.log(cl[c] / o) && --c, e = t[c], i = e[1], e = e[0].range
            }
    ...
    va.dispatch = function() {
        for (var n = new s, t = -1, e = arguments.length; ++t < e;) n[arguments[t]] = h(n);
        return n
    ...
    }, va.event = null, va.requote = function(n) {
        return n.replace(Ca, "\\$&")
    };
    var Ca = /[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g,
        za = function(n, t) {
    ...
    }, La = Sizzle.matchesSelector), va.selection = function() {
        return Oa
    };
    ...
    Ha.select = function(n) {
        ...
        for (var i = -1, u = this.length; ++i < u;)
            for (var a = this[i], o = -1, c = a.length; ++o < c;)(e = a[o]) && (r.push(t = Na(n.call(e, e.__data__, o))), t.parentNode = e);
        return m(r)
    };
    var Fa = {
    ...
    va.ns = {
        ...
        qualify: function(n) {
            var t = n.indexOf(":"),
                e = n;
            return t >= 0 && (e = n.substring(0, t), n = n.substring(t + 1)), Fa.hasOwnProperty(e) ? {
                space: Fa[e],
                local: n
            } : n
        }
        ...
        return n = va.ns.qualify(n), "function" != typeof t && (t = v(t)), this.select(n.local ? r : e)
    }, Ha.remove = function() {
    ...
    var Pa = [];
    va.selection.enter = T, va.selection.enter.prototype = Pa, Pa.append = Ha.append, Pa.insert = Ha.insert, Pa.empty = Ha.empty, Pa.node = Ha.node, Pa.call = Ha.call, Pa.size = Ha.size, Pa.select = function(n) {
    ...
    va.touches = function(n, t) {
        return arguments.length < 2 && (t = p().touches), t ? Na(t).map(function(t) {
            var e = L(n, t);
        ...
        function t() {
            function n() {
                var n = a.parentNode;
                return null != l ? va.touches(n).filter(function(n) {
            ...
            function i() {
                g.on(null != l ? "touchmove.drag-" + l : "mousemove.drag", null).on(null != l ? "touchend.drag-" + l : "mouseup.drag", null), h(s && va.event.target === c), o({
                    type: "dragend"
                })
            }
            var u, a = this,
                ...
                g = va.select(xa).on(null != l ? "touchmove.drag-" + l : "mousemove.drag", t).on(null != l ? "touchend.drag-" + l : "mouseup.drag", i, !0);
            r ? (u = r.apply(a, arguments), u = [u.x - f[0], u.y - f[1]]) : u = [0, 0], o({
                type: "dragstart"
            })
        }
        ...
        function n() {
            this.on("mousedown.zoom", o).on("mousemove.zoom", l).on(Xa + ".zoom", c).on("dblclick.zoom", f).on("touchstart.zoom", s).on("touchmove.zoom", h).on("touchend.zoom", s)
        }
        ...
        function o() {
            ...
            function e() {
                l.on("mousemove.zoom", null).on("mouseup.zoom", null), s(c && va.event.target === o)
            }
            var r = this,
                u = E.of(r, arguments),
                o = va.event.target,
        ...
        function c() {
            g || (g = t(va.mouse(this))), r(Math.pow(2, .002 * Ia()) * w), i(va.mouse(this), g), a(E.of(this, arguments))
        }
        ...
        function f() {
            ...
            r(Math.pow(2, va.event.shiftKey ? Math.ceil(u) - 1 : Math.floor(u) + 1)), i(n, e), a(E.of(this, arguments))
        }

        function s() {
            var n = va.touches(this),
                e = Date.now();
            if (m = w, g = {}, p = 0, n.forEach(function(n) {
                    g[n.identifier] = t(n)
                }), 1 === n.length) {
                if (500 > e - b) {
                    var u = n[0],
        ...
        function h() {
            var n = va.touches(this),
                ...
                e = g[t.identifier];
            if (u = n[1]) {
                var u, o = g[u.identifier],
                    c = va.event.scale;
                if (null == c) {
                    var l = (l = u[0] - t[0]) * l + (l = u[1] - t[1]) * l;
                    c = p && Math.sqrt(l / p)
                }
                t = [(t[0] + u[0]) / 2, (t[1] + u[1]) / 2], e = [(e[0] + o[0]) / 2, (e[1] + o[1]) / 2], r(c * m)
            }
            i(t, e), b = null, a(E.of(this, arguments))
        }
        var g, p, m, v, y, M, x, b, _ = [0, 0],
            w = 1,
            S = Va,
            E = d(n, "zoom");
        return n.translate = function(t) {
            ...
            return arguments.length ? (S = null == t ? Va : t.map(Number), n) : S
        }, n.x = function(t) {
    ...
    var Ia, Va = [0, 1 / 0],
        Xa = "onwheel" in ya ? (Ia = function() {
            return -va.event.deltaY * (va.event.deltaMode ? 120 : 1)
        }, "wheel") : "onmousewheel" in ya ? (Ia = function() {
            return va.event.wheelDelta
        }, "mousewheel") : (Ia = function() {
            return -va.event.detail
        }, "MozMousePixelScroll");
    H.prototype.toString = function() {
        return this.rgb() + ""
    }, va.hsl = function(n, t, e) {
        return 1 === arguments.length ? n instanceof P ? F(n.h, n.s, n.l) : ut("" + n, at, F) : F(+n, +t, +e)
    };
    ...
    va.hcl = function(n, t, e) {
        return 1 === arguments.length ? n instanceof B ? Z(n.h, n.c, n.l) : n instanceof J ? K(n.l, n.a, n.b) : K((n = ot((n = va.rgb(n)).r, n.g, n.b)).l, n.a, n.b) : Z(+n, +t, +e)
    };
    var Ka = B.prototype = new H;
    Ka.brighter = function(n) {
        return Z(this.h, this.c, Math.min(100, this.l + Qa * (arguments.length ? n : 1)))
    }, Ka.darker = function(n) {
        return Z(this.h, this.c, Math.max(0, this.l - Qa * (arguments.length ? n : 1)))
    }, Ka.rgb = function() {
        return $(this.h, this.c, this.l).rgb()
    }, va.lab = function(n, t, e) {
        return 1 === arguments.length ? n instanceof J ? W(n.l, n.a, n.b) : n instanceof B ? $(n.l, n.c, n.h) : ot((n = va.rgb(n)).r, n.g, n.b) : W(+n, +t, +e)
    };
    var Qa = 18,
        no = .95047,
        to = 1,
    ...
    ro.brighter = function(n) {
        return W(Math.min(100, this.l + Qa * (arguments.length ? n : 1)), this.a, this.b)
    }, ro.darker = function(n) {
        return W(Math.max(0, this.l - Qa * (arguments.length ? n : 1)), this.a, this.b)
    }, ro.rgb = function() {
        return G(this.l, this.a, this.b)
    }, va.rgb = function(n, t, e) {
        return 1 === arguments.length ? n instanceof rt ? et(n.r, n.g, n.b) : ut("" + n, et, O) : et(~~n, ~~t, ~~e)
    };
        ...
        return e.parse = function(n, t) {
            ...
            function e() {
                ...
                if (34 === n.charCodeAt(t)) {
                    ...
                    return 13 === r ? (i = !0, 10 === n.charCodeAt(e + 2) && ++f) : 10 === r && (i = !0), n.substring(t + 1, e).replace(/""/g, '"')
                }
                for (; c > f;) {
    ...
    va.timer = function(n, t, e) {
        ...
        oo ? oo.next = i : ao = i, oo = i, co || (lo = clearTimeout(lo), co = 1, fo(dt))
    }, va.timer.flush = function() {
        mt(), vt()
    };
    var fo = xa[o(xa, "requestAnimationFrame")] || function(n) {
            setTimeout(n, 17)
        },
        so = ".",
        ho = ",",
        go = [3, 3],
        po = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(yt);
    va.formatPrefix = function(n, t) {
        var e = 0;
        return n && (0 > n && (n *= -1), t && (n = va.round(n, Mt(n, t))), e = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10), e = Math.max(-24, Math.min(24, 3 * Math.floor((0 >= e ? e + 1 : e - 1) / 3)))), po[8 + e / 3]
        ...
        "#" === u && (u = ""), "r" != f || l || (f = "g"), null != l && ("g" == f ? l = Math.max(1, Math.min(21, l)) : ("e" == f || "f" == f) && (l = Math.max(0, Math.min(20, l)))), f = vo.get(f) || xt;
        var p = a && c;
        return function(n) {
            if (g && n % 1) return "";
            ...
            return p && (n = yo(v + n)), so && n.replace(".", so), t += u, ("<" === r ? t + n + v : ">" === r ? v + t + n : "^" === r ? v.substring(0, m >>= 1) + t + n + v.substring(m) : t + (p ? n : v + n)) + h
        }
    };
    var mo = /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
        vo = va.map({
    ...
    if (go) {
        var Mo = go.length;
        yo = function(n) {
            for (var t = n.lastIndexOf("."), e = t >= 0 ? "." + n.substring(t + 1) : (t = n.length, ""), r = [], i = 0, u = go[0]; t > 0 && u > 0;) r.push(n.substring(t -= u, t + u)), u = go[i = (i + 1) % Mo];
    ...
    va.geo = {}, bt.prototype = {
        ...
        t: 0,
        add: function(n) {
            _t(n, this.t, xo), _t(xo.s, this.s, this), this.s ? this.t += xo.t : this.s = xo.t
        },
        reset: function() {
            this.s = this.t = 0
        },
    ...
    var wo, So = new bt,
        Eo = {
            ...
            polygonEnd: function() {
                var n = 2 * So;
                wo += 0 > n ? 4 * Ba + n : n, Eo.lineStart = Eo.lineEnd = Eo.point = f
            }
        };
    va.geo.bounds = function() {
        ...
        function a() {
            i(d, m), Eo.lineEnd(), Math.abs(y) > $a && (f = -(h = 180)), x[0] = f, x[1] = h, v = null
        }
        ...
        var f, s, h, g, p, d, m, v, y, M, x, b = {
            ...
            lineEnd: r,
            polygonStart: function() {
                b.point = i, b.lineStart = u, b.lineEnd = a, y = 0, Eo.polygonStart()
            },
            polygonEnd: function() {
                Eo.polygonEnd(), b.point = n, b.lineStart = e, b.lineEnd = r, 0 > So ? (f = -(h = 180), s = -(g = 90)) : y > $a ? g = 90 : -$a > y && (s = -90), x[0] = f, x[1] = h
            }
        };
        return function(n) {
        ...
        ko = Ao = No = qo = To = Co = zo = Do = jo = Lo = Ho = 0, va.geo.stream(n, Fo);
        var t = jo,
            e = Lo,
            r = Ho,
            i = t * t + e * e + r * r;
        return Wa > i && (t = Co, e = zo, r = Do, $a > Ao && (t = No, e = qo, r = To), i = t * t + e * e + r * r, Wa > i) ? [0 / 0, 0 / 0] : [Math.atan2(e, t) * Ga, U(r / Math.sqrt(i)) * Ga]
    };
    var ko, Ao, No, qo, To, Co, zo, Do, jo, Lo, Ho, Fo = {
            sphere: f,
            point: Lt,
            lineStart: Ft,
            lineEnd: Pt,
    ...
    (va.geo.conicEqualArea = function() {
        ...
        var t, e, r, i, u = va.geo.albers(),
            a = va.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
            o = va.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
            c = {
                point: function(n, e) {
                    t = [n, e]
                }
    ...
    va.geo.path = function() {
        ...
        return n.area = function(n) {
            ...
            return No = qo = To = Co = zo = Do = jo = Lo = Ho = 0, va.geo.stream(n, i(Wo)), Ho ? [jo / Ho, Lo / Ho] : Do ? [Co / Do, zo / Do] : To ? [No / To, qo / To] : [0 / 0, 0 / 0]
        }, n.bounds = function(n) {
            return Xo = Zo = -(Io = Vo = 1 / 0), va.geo.stream(n, i($o)), [
                [Io, Vo],
                [Xo, Zo]
            ]
            ...
            return arguments.length ? (u = null == (r = n) ? new ae : new he(n), "function" != typeof o && u.pointRadius(o), t()) : r
        ...
        return n = Me(n[0] % 360 * Ja, n[1] * Ja, n.length > 2 ? n[2] * Ja : 0), t.invert = function(t) {
            return t = n.invert(t[0] * Ja, t[1] * Ja), t[0] *= Ga, t[1] *= Ga, t
        }, t
    ...
    (va.geo.azimuthalEquidistant = function() {
        return de(Qo)
    }).raw = Qo, (va.geo.conicConformal = function() {
        return ee(ze)
    ...
    va.geom.hull = function(n) {
        ...
        function t(n) {
            ...
            if (c === Pe && l === Oe) t = n;
                ...
                for (t = new Array(f), a = 0; f > a; ++a) t[a] = [+c.call(this, u = n[a], a), +l.call(this, u, a)];
            if (lr(t, function(n) {
                    var t, e, r, i, u, a;
                    1 === n.a && n.b >= 0 ? (t = n.ep.r, e = n.ep.l) : (t = n.ep.l, e = n.ep.r), 1 === n.a ? (u = t ? t.y : -s, r = n.c - n.b * u, a = e ? e.y : s, i = n.c - n.b * a) : (r = t ? t.x : -s, u = n.c - n.a * r, i = e ? e.x : s, a = n.c - n.a * i);
                    var c = [r, u],
                        l = [i, a];
                    ...
                    if (!(r > 2)) {
                        ...
                        if (Math.abs(d) < $a) {
                            ...
                            var m = (l - o) * (g - f) > (h - l) * (f - c) ? s : -s,
                                y = Math.abs(d) - p;
                            Math.abs(y) < $a ? n.push([0 > d ? m : -m, m]) : (y > 0 && (m *= -1), n.push([-s, m], [s, m]))
                        }
                    }
                }), i)
        ...
        return arguments.length ? t(n) : (t.x = function(n) {
            ...
            if (c === Pe && l === Oe) t = n;
                ...
                for (t = new Array(f), u = 0; f > u; ++u) t[u] = [+c.call(this, i = n[u], u), +l.call(this, i, u)];
            ...
            for (var t, i = new Array(c), u = ft(e), a = ft(r), o = -1, c = n.length; ++o < c;)(i[o] = [+u.call(this, t = n[o], o), +a.call(this, t, o)]).data = t;
    ...
    va.interpolate = wr, va.interpolators = [function(n, t) {
        var e = typeof t;
        return ("string" === e ? uo.has(t) || /^(#|rgb\(|hsl\()/.test(t) ? pr : _r : t instanceof H ? pr : "object" === e ? Array.isArray(t) ? Er : br : Mr)(n, t)
    ...
    va.ease = function(n) {
        ...
        return e = sc.get(e) || fc, r = hc.get(r) || st, kr(r(e.apply(null, Array.prototype.slice.call(arguments, 1))))
        ...
        return o.tick = function() {
            ...
            if (g)
                for (Kr(t = va.geom.quadtree(m), r, a), e = -1; ++e < b;)(o = m[e]).fixed || t.visit(n(o));
            ...
            for (e = 0; d > e; ++e) f = v[e], "number" == typeof f.source && (f.source = m[f.source]), "number" == typeof f.target && (f.target = m[f.target]), ++f.source.weight, ++f.target.weight;
    ...
    va.layout.hierarchy = function() {
        ...
        function n(u) {
            var a = u.map(function(e, r) {
                ...
                c = (("function" == typeof i ? i.apply(this, arguments) : i) - o) / va.sum(a),
                l = va.range(u.length);
            null != e && l.sort(e === dc ? function(n, t) {
                return a[t] - a[n]
            } : function(n, t) {
                return e(u[n], u[t])
            });
    ...
    va.layout.stack = function() {
        ...
        return n.values = function(e) {
            ...
            return arguments.length ? (e = "function" == typeof t ? t : mc.get(t) || oi, n) : e
        }, n.offset = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : vc.get(t) || ci, n) : r
        }, n.x = function(t) {
    ...
    va.layout.histogram = function() {
        function n(n, u) {
            ...
            if (g > 0)
                for (u = -1; ++u < h;) o = l[u], o >= f[0] && o <= f[1] && (a = c[va.bisect(s, o, 1, g) - 1], a.y += p, a.push(n[u]));
            return c
        }
        var t = !0,
            e = Number,
        ...
        var t, e = va.layout.hierarchy().sort(ki),
            r = 0,
            i = [1, 1];
    ...
    var xc = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b", "#e377c2", "#7f7f7f", "#bcbd22", "#17becf"],
        bc = ["#1f77b4", "#aec7e8", "#ff7f0e", "#ffbb78", "#2ca02c", "#98df8a", "#d62728", "#ff9896", "#9467bd", "#c5b0d5", "#8c564b", "#c49c94", "#e377c2", "#f7b6d2", "#7f7f7f", "#c7c7c7", "#bcbd22", "#dbdb8d", "#17becf", "#9edae5"],
        _c = ["#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252", "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94", "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194", "#ce6dbd", "#de9ed6"],
        wc = ["#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c", "#fdae6b", "#fdd0a2", "#31a354", "#74c476", "#a1d99b", "#c7e9c0", "#756bb1", "#9e9ac8", "#bcbddc", "#dadaeb", "#636363", "#969696", "#bdbdbd", "#d9d9d9"];
    ...
    Tc.call = Ha.call, Tc.empty = Ha.empty, Tc.node = Ha.node, Tc.size = Ha.size, va.transition = function(n) {
        return arguments.length ? Ac ? n.transition() : n : Oa.transition()
    }, va.transition.prototype = Tc, Tc.select = function(n) {
        var t, e, r, i = this.id,
            u = [];
        "function" != typeof n && (n = v(n));
        for (var a = -1, o = this.length; ++a < o;) {
        ...
        var e = this.id;
        return arguments.length < 2 ? this.node().__transition__[e].tween.get(n) : q(this, null == t ? function(t) {
        ...
        var t = this.id;
        return arguments.length < 1 ? this.node().__transition__[t].ease : ("function" != typeof n && (n = va.ease.apply(va, arguments)), q(this, function(e) {
            e.__transition__[t].ease = n
        }))
    }, Tc.delay = function(n) {
        var t = this.id;
        return q(this, "function" == typeof n ? function(e, r, i) {
        ...
        if (arguments.length < 2) {
            var r = zc,
                i = Ac;
            Ac = e, q(this, function(t, r, i) {
                zc = t.__transition__[e], n.call(t, t.__data__, r, i)
            }), zc = r, Ac = i
        } else q(this, function(r) {
        ...
        function n(n) {
            n.each(function() {
                var n, s = va.select(this),
                    ...
                    E = (S.enter().append("path").attr("class", "domain"), va.transition(S)),
                    k = e.copy(),
                    A = this.__chart__ || k;
    ...
    va.svg.brush = function() {
        function n(u) {
            u.each(function() {
                var u, a = va.select(this),
                    f = a.selectAll(".background").data([0]),
                    s = a.selectAll(".extent").data([0]),
                    h = a.selectAll(".resize").data(l, String);
                a.style("pointer-events", "all").on("mousedown.brush", i).on("touchstart.brush", i), f.enter().append("rect").attr("class", "background").style("visibility", "hidden").style("cursor", "crosshair"), s.enter().append("rect").attr("class", "extent").style("cursor", "move"), h.enter().append("g").attr("class", function(n) {
                    return "resize " + n
                ...
                }).attr("width", 6).attr("height", 6).style("visibility", "hidden"), h.style("display", n.empty() ? "none" : null), h.exit().remove(), o && (u = Ui(o), f.attr("x", u[0]).attr("width", u[1] - u[0]), e(a)), c && (u = Ui(c), f.attr("y", u[0]).attr("height", u[1] - u[0]), r(a)), t(a)
            })
        }

        function t(n) {
            n.selectAll(".resize").attr("transform", function(n) {
                return "translate(" + f[+/e$/.test(n)][0] + "," + f[+/^s/.test(n)][1] + ")"
            })
        }

        function e(n) {
            n.select(".extent").attr("x", f[0][0]), n.selectAll(".extent,.n>rect,.s>rect").attr("width", f[1][0] - f[0][0])
        }

        function r(n) {
            n.select(".extent").attr("y", f[0][1]), n.selectAll(".extent,.e>rect,.w>rect").attr("height", f[1][1] - f[0][1])
        }
        ...
        function i() {
            ...
            function l() {
                32 == va.event.keyCode && (k || (v = null, N[0] -= f[1][0], N[1] -= f[1][1], k = 2), g())
            }

            function h() {
                32 == va.event.keyCode && 2 == k && (N[0] += f[1][0], N[1] += f[1][1], k = 0, g())
            }

            function p() {
                var n = i(),
                    u = !1;
                y && (n[0] += y[0], n[1] += y[1]), k || (va.event.altKey ? (v || (v = [(f[0][0] + f[1][0]) / 2, (f[0][1] + f[1][1]) / 2]), N[0] = f[+(n[0] < v[0])][0], N[1] = f[+(n[1] < v[1])][1]) : v = null), S && d(n, o, 0) && (e(_), u = !0), E && d(n, c, 1) && (r(_), u = !0), u && (t(_), b({
                    type: "brush",
                    mode: k ? "move" : "resize"
                }))
            }
            ...
            function d(n, t, e) {
                var r, i, a = Ui(t),
                    ...
                    l = N[e],
                    h = f[1][e] - f[0][e];
                return k && (o -= l, c -= h + l), r = s[e] ? Math.max(o, Math.min(c, n[e])) : n[e], k ? i = (r += l) + h : (v && (l = Math.max(o, Math.min(c, 2 * v[e] - r))), r > l ? (i = r, r = l) : i = l), f[0][e] !== r || f[1][e] !== i ? (u = null, f[0][e] = r, f[1][e] = i, !0) : void 0
            }

            function m() {
                p(), _.style("pointer-events", "all").selectAll(".resize").style("display", n.empty() ? "none" : null), va.select("body").style("cursor", null), q.on("mousemove.brush", null).on("mouseup.brush", null).on("touchmove.brush", null).on("touchend.brush", null).on("keydown.brush", null).on("keyup.brush", null), A(), b({
                    type: "brushend"
                })
            }
            var v, y, M = this,
            ...
            if (va.event.changedTouches ? q.on("touchmove.brush", p).on("touchend.brush", m) : q.on("mousemove.brush", p).on("mouseup.brush", m), k) N[0] = f[0][0] - N[0], N[1] = f[0][1] - N[1];
            else if (w) {
                var T = +/w$/.test(w),
                    C = +/^n/.test(w);
                y = [f[1 - T][0] - N[0], f[1 - C][1] - N[1]], N[0] = f[T][0], N[1] = f[C][1]
            } else va.event.altKey && (v = N.slice());
            _.style("pointer-events", "none").selectAll(".resize").style("display", null), va.select("body").style("cursor", x.style("cursor")), b({
                type: "brushstart"
            }), p()
        }
        var u, a = d(n, "brushstart", "brush", "brushend"),
            o = null,
            c = null,
            l = Hc[0],
            f = [
        ...
        return n.x = function(t) {
            ...
            return arguments.length ? (o && c ? s = [!!t[0], !!t[1]] : (o || c) && (s[+!o] = !!t), n) : o && c ? s : o || c ? s[+!o] : null
        }, n.extent = function(t) {
            var e, r, i, a, l;
    ...
    var Oc = Date.prototype,
        ...
        Yc = "%m/%d/%Y",
        Uc = "%H:%M:%S",
        Ic = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
    ...
    va.time.year = zu(function(n) {
        ...
        function t(t) {
            for (var r, i, u, a = [], o = -1, c = 0; ++o < e;) 37 === n.charCodeAt(o) && (a.push(n.substring(c, o)), null != (i = el[r = n.charAt(++o)]) && (r = n.charAt(++o)), (u = rl[r]) && (r = u(t, null == i ? "e" === r ? " " : "0" : i)), a.push(r), c = o + 1);
    ...
    va.time.format.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? oa : ol, oa.parse = function(n) {
        var t = new Date(n);
        return isNaN(t) ? null : t
    }, oa.toString = ol.toString, va.time.second = zu(function(n) {
    ...
    var cl = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6],
        ll = [
            [va.time.second, 1],
            [va.time.second, 5],
            [va.time.second, 15],
