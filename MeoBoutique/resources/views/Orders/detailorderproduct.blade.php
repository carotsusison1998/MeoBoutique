...
<div class="card">
	<div class="card-body">
		<h4 class="card-title">Chi tiết đơn hàng số {{ $phieuxuat->id }} của: {{ $khachhang->tenkhachhang }}</h4>
		<div class="table-responsive m-t-40">
			...
			<table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
				...
				<tbody id="myTable">
					@foreach($chitietphieuxuat as $value)
					<?php 
					...
					<tr>
						...
						<td>{{ number_format($value['giaxuat']) }} vnd</td>
						<td>{{ $value['soluong'] }}</td>
